...
// colors
var colors = ['#ff3031', '#68ac0d', '#00a8da', '#fbc500', '#E91E63', '9C27B0', '#673AB7', '#FF9800', '#FF5722', '#009688', '#00BCD4', '#3F51B5', '#03A9F4', '#CDDC39', '#8BC34A'];
...
var Pane = function(cell) {
  ...
  this.init = function() {
    ...
    trend.href = 'http://www.google.com/search?q=' + trend.title;
    trend.innerHTML = '';
